...
!
      REAL(kind=KFPT),DIMENSION(IMS:IME,JMS:JME),INTENT(OUT) :: AKHS_OUT,AKMS_OUT  &
                                                               ...
                                                               ,U10,V10
!
      REAL(kind=KFPT),DIMENSION(IMS:IME,JMS:JME,1:LM),INTENT(IN) :: U_PHY,V_PHY
!
...
!
      REAL(kind=KFPT),DIMENSION(IMS:IME,JMS:JME,1:LM),INTENT(OUT) :: DUDT,DVDT &
                                                                    ,XLEN_MIX
!
      REAL(kind=KFPT),DIMENSION(NSOIL),INTENT(IN) :: DZSOIL
!
...
!-----------------------------------------------------------------------
!
!rv   IF(TRIM(TURBULENCE)/='myj')THEN
!rv     LENGTH_ROW=ITE-ITS+1
!rv     DO J=JTS,JTE
!rv     DO I=ITS,ITE
!rv       LPBL(I,J)=-1000
!rv     ENDDO
...
!.......................................................................
!rv!$omp parallel do                                                       &
!rv!$omp& private(j,kount_all,k,i,altitude)
!.......................................................................
!rv     DO J=JTS,JTE
!rv       KOUNT_ALL=0
!rv       find_Lpbl : DO K=LM,1,-1
!rv       DO I=ITS,ITE
!rv         ALTITUDE=Z(I,J,K)-SFCZ(I,J)
!rv         IF(PBLH(I,J)<=ALTITUDE.AND.LPBL(I,J)<0)THEN
!rv           LPBL(I,J)=K
!rv           KOUNT_ALL=KOUNT_ALL+1
!rv         ENDIF
!rv         IF(KOUNT_ALL==LENGTH_ROW)EXIT find_Lpbl
!rv       ENDDO
!rv       ENDDO find_Lpbl
!rv     ENDDO
!.......................................................................
!rv!$omp end parallel do
!.......................................................................
!rv   ENDIF
!
      IF(SURFACE_PHYSICS==99 .OR. SURFACE_PHYSICS==LISSSCHEME)THEN
