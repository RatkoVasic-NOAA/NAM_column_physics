...
!---------------------------------------------------------------------
        ...
        ITSLOC = ITS !rv MAX(ITS_B1,IDS)
        ITELOC = ITE !rv MIN(ITE_B1,IDE-1)
        JTSLOC = JTS !rv MAX(JTS_B1,JDS)
        JTELOC = JTE !rv MIN(JTE_B1,JDE-1)
...
!----------------------
!
      INTEGER,INTENT(IN) :: NTIMESTEP,LM,IMS,IME,JMS,JME
!
      CHARACTER(99),INTENT(IN) :: MICROPHYSICS
!
...
!
      ...
      LOGICAL,INTENT(IN) :: SPEC_ADV
      INTEGER,INTENT(IN) :: LM,IMS,IME,JMS,JME
!
!--  Local Variables
!
