...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
!-----------------------------------------------------------------------
      SUBROUTINE FER_HIRES (itimestep,DT,RHgrd,                         &
...
!-----------------------------------------------------------------------
      SUBROUTINE FERRIER_INIT_hr (GSMDT,DT,restart,                     &
     &   MP_RESTART_STATE,TBPVS_STATE,TBPVS0_STATE,                     &
     &   ALLOWED_TO_READ,                                               &
     &   MPI_COMM_COMP,MYPE)
!-----------------------------------------------------------------------
...
!        read(etampnew_unit1) my_growth    ! Applicable only for DTPH=180 s
        ...
        ENDIF
!
!rv-mpi        CALL MPI_BCAST(VENTR1,SIZE(VENTR1),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VENTR2,SIZE(VENTR2),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(ACCRR,SIZE(ACCRR),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(MASSR,SIZE(MASSR),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VRAIN,SIZE(VRAIN),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(RRATE,SIZE(RRATE),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VENTI1,SIZE(VENTI1),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VENTI2,SIZE(VENTI2),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(ACCRI,SIZE(ACCRI),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(MASSI,SIZE(MASSI),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VSNOWI,SIZE(VSNOWI),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!rv-mpi        CALL MPI_BCAST(VEL_RF,SIZE(VEL_RF),MPI_REAL,0  &
!rv-mpi                      ,MPI_COMM_COMP,IRTN)
!
