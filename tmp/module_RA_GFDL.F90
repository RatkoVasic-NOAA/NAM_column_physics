...
!
      DO K=1,LM
!rv     DO J=JTS_B1,JTE_B1
!rv     DO I=ITS_B1,ITE_B1
        DO J=JTS,JTE
        DO I=ITS,ITE
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
!---------------------------------------------------------------------
      SUBROUTINE GFDL_INIT(SFULL,SHALF,PPTOP,                           &
...
!
      IF(CO2TF==1)THEN
        CALL CO2O3(SFULL,SHALF,PPTOP,LM,LM+1,LM+2)
      ELSE
        CALL CONRAD(1,LM+1)
      ENDIF
!
...
!-----------------------------------------------------------------------
     ...
     &                                                           q,     &
     &                                                        PI3D
      REAL,INTENT(IN),DIMENSION(:, :, :) :: qs, qi, qw
