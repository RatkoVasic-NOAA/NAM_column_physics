...
!====================================================================
!----Modification to use MODIS ALBEDO and default, Lin 20170206

        ! write(6,*), '***** IALBFLG= ', IALBFLG

        IF (ialbflg==1) THEN  ! MODIS Albedo
...
!------------------------------------------------------
  ...
  SUBROUTINE NOAH_LSM_INIT(IVEGSRC,MYPE,MPI_COMM)

    INTEGER,INTENT(IN)::IVEGSRC,MYPE,MPI_COMM
!
    MYPE_SHARE = MYPE
...
!
      ...
      ENDIF
!
!rv-mpi  CALL MPI_BCAST(LUTYPE      ,4    ,MPI_CHARACTER ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(LUCATS      ,1    ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(IINDEX      ,1    ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(LUMATCH     ,1    ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(ALBTBL      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(Z0TBL       ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SHDTBL      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(NROTBL      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(RSTBL       ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(RGLTBL      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(HSTBL       ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SNUPTBL     ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(LAITBL      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(MAXALB      ,NLUS ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(TOPT_DATA   ,1    ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(CMCMAX_DATA ,1    ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(CFACTR_DATA ,1    ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(RSMAX_DATA  ,1    ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(BARE        ,1    ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!                                                                       
...
!
!rv-mpi  CALL MPI_BCAST(LUMATCH ,1       ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SLTYPE  ,4       ,MPI_CHARACTER ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(MMINSL  ,4       ,MPI_CHARACTER ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SLCATS  ,1       ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(IINDEX  ,1       ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(BB      ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(DRYSMC  ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(F11     ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(MAXSMC  ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(REFSMC  ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SATPSI  ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SATDK   ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SATDW   ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(WLTSMC  ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(QTZ     ,NSLTYPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!
...
!rv
        ...
        CLOSE (19)                                                        
           ENDIF
!
!rv-mpi  CALL MPI_BCAST(NUM_SLOPE   ,1      ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SLPCATS     ,1      ,MPI_INTEGER   ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SLOPE_DATA  ,NSLOPE ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SBETA_DATA  ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(FXEXP_DATA  ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(CSOIL_DATA  ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SALP_DATA   ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(REFDK_DATA  ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(REFKDT_DATA ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(FRZK_DATA   ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(ZBOT_DATA   ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(CZIL_DATA   ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SMLOW_DATA  ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
!rv-mpi  CALL MPI_BCAST(SMHIGH_DATA ,1      ,MPI_REAL      ,0,MPI_COMM_COMP,IRTN)
